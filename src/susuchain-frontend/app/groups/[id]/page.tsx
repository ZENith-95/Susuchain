          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                {!isUserMember && currentGroup.members.length < currentGroup.maxMembers && (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="font-semibold">{formatICP(BigInt(currentGroup.contributionAmount))} ICP</div>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="font-semibold">
                    {currentGroup.currentCycle}/{currentGroup.totalCycles}
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="font-semibold text-xs">{formatDate(currentGroup.nextPayoutDate)}</div>
                </div>
              </div>
            </div>
          </CardContent>
